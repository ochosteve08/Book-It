    ...
    <>
      ...
      <div className="px-12 py-12 max-w-2xl mx-auto text-justify">
        ...
        <p className="mb-4 text-slate-700">
          ...
          to protected routes only for authenticated users. Using Firebase
          google authentication, Google signup/sign-in is also integrated into
          the nodejs.
        </p>
        <p className="mb-4 text-slate-700">
        ...
        <p className="mb-4 text-slate-700">
          ...
          profile picture, which is stored on firebase storage, and the photo
          link made available to be saved on mongodb, authenticated users can
          update profile info and update password as well. In the event of not
          needing the account any longer, users can delete their account.
        </p>
      </div>
    </>
  );
